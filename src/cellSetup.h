...
#define DEFAULT_STEP_INTERVAL 0.6f //0.2f
#define DEFAULT_STEP_INTERVAL_NORMAL_MODE 0.15f
#define DEFAULT_MOV_FIX ( BASIC_MOV_FIX * 3.0f)
#define DEFAULT_RANDOM_WALK_FIX ( BASIC_RANDOM_WALK_FIX * 2.0 )
...
#define PS_CATHARSIS_RANDOM_WALK_FIX 0.6f
